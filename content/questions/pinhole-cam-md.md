...
Существует 5 внутренних параметров камеры, они не обходимы для преобразований на плоскости изображения, т.е. в 2D. Сюда входят, координаты центра изображения  $u_{0}$
