...
Существует 5 внутренних параметров камеры, они не обходимы для преобразований на плоскости изображения, т.е. в 2D. Сюда входят, координаты центра изображения , фокусное расстояние *f(y) и коэффициенты дисторсии. Обычно записывают внутренние параметры  камеры в виде матрицы:

   ![13-08-2018 17-23-18](https://research-journal.org/wp-content/uploads/2018/08/13-08-2018-17-23-18.png)
